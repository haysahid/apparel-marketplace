    ...
    <div
        ...
        :class="{
            ...
            'text-yellow-800 border-yellow-300 bg-yellow-50':
                props.type === 'warning',
            'text-red-800 border-red-300 bg-red-50': props.type === 'error',
    ...
    >
        <span>
            <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                class="transition-colors duration-200 size-5 sm:size-6"
                :class="{
                    'fill-blue-800': props.type === 'info',
                    'fill-yellow-800': props.type === 'warning',
                    'fill-red-800': props.type === 'error',
                    'fill-green-800': props.type === 'success',
                }"
            >
                <path

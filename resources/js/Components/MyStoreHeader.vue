...
<template>
    <BaseHeader @showStoreOptionsDialog="showStoreOptionsDialog = true">
        ...
        <template #trailing>
            ...
            <div class="relative ms-3">
                <UserDropdown
                    @showStoreOptionsDialog="showStoreOptionsDialog = true"
                />
            </div>
        </template>
        ...
        <template #responsiveMenu>
            <!-- Store Card -->
            <div v-if="$page.props.selected_store" class="w-full px-4 mt-4">
                <StoreItem

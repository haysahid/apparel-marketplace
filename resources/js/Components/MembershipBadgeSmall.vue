...
<template>
    <div
        class="flex items-center justify-center gap-0.5 px-1.5 py-1 text-[10px] font-semibold text-center rounded-full w-fit h-fit whitespace-nowrap leading-none"
        :style="{

    ...
    <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-4">
            ...
            <div class="flex gap-4">
                <InputLabel
                    for="motif"
                    value="Motif"
                    class="!text-gray-500 min-w-[80px] py-1.5 h-min"
                />
        ...
        <div>
            ...
            >
                ...
                <PrimaryButton
                    type="button"
                    class="py-2 !text-base !font-bold w-full sm:w-auto"
                    @click="addToCart"
                >
                    <template #prefix>
                        <svg
                            ...
                            height="25"
                            viewBox="0 0 24 25"
                            class="fill-white size-5 shrink-0"
                        >
                            <path
                    ...
                    <p class="font-semibold text-white w-fit">
                        {{
                            isVariantInCart
                                ? "Perbarui Keranjang"
                                : "Masukkan Keranjang"

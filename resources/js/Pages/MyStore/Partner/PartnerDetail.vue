...
<template>
    <MyStoreLayout
        ...
        :showTitle="true"
        :breadcrumbs="[
            { text: 'Mitra', url: '/my-store/partner', active: false },
            { text: 'Detail Mitra', active: true },
        ]"
    >
        <div class="flex flex-col w-full gap-1 sm:gap-2 p-1.5 sm:p-0">
            ...
            <DefaultCard>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div
                                v-if="props.partner.contact_name"
                            ...
                            >
                                ...
                                <span>
                                    {{ props.partner.contact_name }}
                                </span>
                            </div>
                            <div
                                v-if="props.partner.contact_email"
                                class="flex items-center gap-0.5"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <span>
                                    {{ props.partner.contact_email }}
                                </span>
                            </div>
                            <div
                                v-if="props.partner.contact_phone"
                                class="flex items-center gap-0.5"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex items-center w-full gap-1 sm:gap-2">
                <SummaryCard
                    title="Total Voucher"
                    :value="$formatNumber(props.count_vouchers)"
                />
                <SummaryCard
                    title="Total Saldo"
                    :value="$formatCurrency(props.current_balance)"
                />
                <SummaryCard
                    title="Total Penarikan"
                    :value="$formatCurrency(props.withdrawal_balance)"
                />
            </div>

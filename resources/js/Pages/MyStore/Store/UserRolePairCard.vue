...
<template>
    ...
    >
        ...
        <div
            class="flex flex-col w-full gap-2 sm:flex-row sm:justify-between pt-0.5"
        >
            <div class="flex flex-col items-start">
                <p
                    class="text-sm font-semibold text-gray-900 transition-all duration-300 ease-in-out line-clamp-1 overflow-ellipsis"
                >
                ...
                <p
                    class="text-xs text-gray-600 break-all line-clamp-1 overflow-ellipsis"
                >

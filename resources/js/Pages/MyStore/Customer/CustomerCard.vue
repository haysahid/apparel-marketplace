                    ...
                    <div>
                        <div class="flex items-center gap-2 pe-12">
                            <div class="flex items-center gap-2">
                                ...
                                <template
                                    v-if="
                                        props.customer.store_memberships
                                            .length > 0
                                    "
                                >
                                    <div
                                        v-for="membership in props.customer
                                            .store_memberships"
                                        class="flex items-center gap-2"
                                    >
                                        <Tooltip
                                            :id="`membership-tooltip-${props.customer.id}-${membership.id}`"
                                            placement="bottom"
                                            :bgColorHexCode="
            ...
            <div class="grid w-full grid-cols-4 gap-1 mt-2">
                <div class="flex flex-col w-full px-2 py-1">
                    <span class="text-sm font-medium text-blue-600">
                        {{ $formatNumber(props.customer.count_active_orders) }}
                    </span>
                ...
                <div class="flex flex-col w-full px-2 py-1">
                    <span class="text-sm font-medium text-green-600">
                        {{
                            $formatNumber(props.customer.count_completed_orders)
                        }}
                    </span>
                    <span class="text-[10px] text-gray-600">
                        Pesanan <br />
                ...
                <div class="flex flex-col w-full px-2 py-1">
                    <span class="text-sm font-medium text-red-600">
                        {{
                            $formatNumber(props.customer.count_cancelled_orders)
                        }}
                    </span>
                    <span class="text-[10px] text-gray-600">
                        Pesanan <br />
                ...
                <div class="flex flex-col w-full px-2 py-1">
                    <span class="text-sm font-medium text-gray-900">
                        {{ $formatCurrency(props.customer.total_spent) }}
                    </span>
                    <span class="text-[10px] text-gray-600">
                        Total <br />
                        Belanja

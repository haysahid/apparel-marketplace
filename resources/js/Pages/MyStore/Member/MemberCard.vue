...
<template>
    ...
    >
        <div
            class="flex flex-col w-full lg:flex-row lg:justify-between lg:items-center gap-x-4"
        >
            <div class="flex w-full gap-2">
                ...
                >
                    <div class="flex flex-col gap-1.5">
                        ...
                        <template
                            v-if="props.member.store_memberships.length > 0"
                        >
                            <div
                                v-for="membership in props.member
                                    .store_memberships"
                                class="flex items-center gap-2"
                            >
                                <div class="flex items-center gap-2">
                                    <Tooltip
                                        :id="`membership-tooltip-${props.member.id}-${membership.id}`"
                                        placement="bottom"
                    ...
                    >
                        ...
                        <div
                            v-if="props.member.store_roles?.length"
                            class="flex items-center gap-0.5"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
            ...
            <!-- Stats -->
            <div class="grid w-full grid-cols-4 gap-1 mt-2">
                <div class="flex flex-col w-full px-2 py-1">
                    <span class="text-sm font-medium text-blue-600">
                        {{ $formatNumber(props.member.count_active_orders) }}
                    </span>
                ...
                <div class="flex flex-col w-full px-2 py-1">
                    <span class="text-sm font-medium text-green-600">
                        {{ $formatNumber(props.member.count_completed_orders) }}
                    </span>
                    <span class="text-[10px] text-gray-600">
                        Pesanan <br />
                        Selesai
                ...
                <div class="flex flex-col w-full px-2 py-1">
                    <span class="text-sm font-medium text-red-600">
                        {{ $formatNumber(props.member.count_cancelled_orders) }}
                    </span>
                    <span class="text-[10px] text-gray-600">
                        Pesanan <br />
                        Dibatalkan
                ...
                <div class="flex flex-col w-full px-2 py-1">
                    <span class="text-sm font-medium text-gray-900">
                        {{ $formatCurrency(props.member.total_spent) }}
                    </span>
                    <span class="text-[10px] text-gray-600">
                        Total <br />
                        Belanja

...
<template>
    <AdminLayout title="Dashboard" :showTitle="true">
        <div class="flex flex-col gap-1 p-2 sm:p-0 sm:gap-4">
            <div
                class="grid grid-cols-1 gap-1 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3"
            >
                <SummaryCard title="Total Produk" :value="props.productCount">
                    <template #icon>
                        <svg
                ...
                <SummaryCard title="Total Pengguna" :value="props.userCount">
                    <template #icon>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="60"

...
class ProductVariantController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'barcode.max' => 'Panjang barcode maksimal 255 karakter.',
            'motif.string' => 'Motif harus berupa teks.',
            'motif.max' => 'Panjang motif maksimal 255 karakter.',
            ...
            'material.string' => 'Bahan harus berupa teks.',
            'material.max' => 'Panjang bahan maksimal 255 karakter.',
